 ...
 */
export const FRONTEND_HOST = 'http://localhost:8080';

/**
 * Base route path for GitHub Pages deployment
 */
export const FRONTEND_BASE_ROUTE = '/ai-coding-as-a-blackbox/';

/**
 * Full frontend URL combining host and base route
 */
export const FRONTEND_BASE_URL = FRONTEND_HOST + FRONTEND_BASE_ROUTE;